...
<main class="main">
    ...
    <form class="toDo-form none" action="/calendar/add" method="POST">
        <button class="toDo-form__close-btn">&#128938</button>
        ...
        <label class="task-comment">
            ...
            <textarea class="task-comment__comment" value="''" name="comment" cols="20" rows="3"></textarea>
        </label>
        ...
        <div class="filter-wrapper">
            <div class="status-filter-wrapper">
                <select class="status-filter-wrapper__select">
                    <?php 
                        echo '<option value="0" checked>All</option>'; 
                        echo '<option value="' . $tasks_statuses[0][0] . '">' . $tasks_statuses[0][1] . '</option>';
                        for ($i=1; $i < sizeof($tasks_statuses); $i++) { 
                            echo '<option value="' . $tasks_statuses[$i][0] . '" checked>' . $tasks_statuses[$i][1] . '</option>';
                        }
                    ?>
                </select>
            </div>
            ...
            <div class="time-filter-wrapper">
                <span class="time-filter-wrapper__option checked" value="all" checked>All</span>
            ...
            <button class="filter-wrapper__reset-btn">Reset filters</button>
        </div>
                    ...
                    foreach ($tasks as $key => $value) {
                        ...
                        echo(
                            '<li class="toDo-list__item">
                                ...
                                <div class="hidden-content none" value="' . $value[0] . '">
                                    <div class="hidden-content__title">Task Comment:</div>
                                    <div class="hidden-content__comment" >' . $value[8] . '</div>
                                </div>
                            </li>'
                        );
                    }
...
<div class="modal-wrapper none">
    <div class="modal-window">
        <div class="modal-header">
            ...
            <button class="modal-header__close-btn">&#128938</button>
        </div>
